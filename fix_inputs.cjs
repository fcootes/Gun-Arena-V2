...
const endIdx = code.indexOf("if (e.code === 'Digit1') setPlayerSlot(0);");
...
if (startIdx !== -1 && endIdx !== -1) {
  ...
  code = code.replace(/if \(e\.code === 'Digit1'\) setPlayerSlot\(0\);\s*if \(e\.code === 'Digit2'\) setPlayerSlot\(1\);\s*if \(e\.code === 'Digit3'\) setPlayerSlot\(2\);/g, 
  "if (e.code === 'Digit1') setPlayerSlot(0);\n      if (e.code === 'Digit2') setPlayerSlot(1);\n      if (e.code === 'Digit3') setPlayerSlot(2);\n      if (e.code === 'Digit4') activateMedkit();");
